...
List<Widget> createListTiles() {
  ...
  triggerNotification(String foodTime, String breakfastFood, DateTime scheduledTime) {
  ...
  // DateTime breakfastTime = DateTime(now.year, now.month, now.day, 18, 0, 40, 0);

  DateTime breakfastTime = DateTime(now.year, now.month, now.day, 7, 12, 10);
  DateTime lunchTime = DateTime(now.year, now.month, now.day, 12, 31, 10);
  DateTime snacksTime = DateTime(now.year, now.month, now.day, 16, 12, 10);
  DateTime dinnerTime = DateTime(now.year, now.month, now.day, 18, 12, 10);
